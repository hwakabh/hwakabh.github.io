...
## Bug Reports
For bug reports or requests [submit an issue](https://github.com/hwakabh/hwakabh.github.io/issues).
...
## Pull Requests
The preferred way to contribute is to fork the [main repository](https://github.com/hwakabh/hwakabh.github.io) on GitHub.
...
1. Fork the [main repository](https://github.com/hwakabh/hwakabh.github.io).  Click on the 'Fork' button near the top of the page.  This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:
```shell
$ git clone git@github.com:${YOUR_USERNAME}/hwakabh.github.io.git
$ cd hwakabh.github.io
```
...
6. Finally, go to the web page of your fork of the `hwakabh.github.io` repo and click 'Pull Request' to send your changes for review.
